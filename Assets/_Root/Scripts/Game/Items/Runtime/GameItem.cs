...
namespace _Root.Scripts.Game.Items.Runtime
{
    ...
    {
        public override bool CanPick<TComponent>(GameObject picker, Vector3 position, int amount,
            out TComponent pickerComponent)
        {
        ...
        public override bool CanUse<TComponent>(GameObject user, Vector3 position, int amount,
            out TComponent userComponent)
        {
        ...
        public override bool CanDrop<TComponent>(GameObject dropper, Vector3 position, int amount,
            out TComponent dropperComponent)
        {
