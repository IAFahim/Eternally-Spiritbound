...
namespace _Root.Scripts.Game.Popup.DailyReward
{
    ...
    public partial class DailyRewardView : View
    {
        ...
        [SerializeField] private _Root.Scripts.Game.Popup.DailyReward.DailyRewardDayElement dayPrefab;
        [SerializeField] private Transform content;
        [SerializeField] private List<DailyRewardData> datas;
        [SerializeField] private DailyRewardData specialDayData;
        [SerializeField] private _Root.Scripts.Game.Popup.DailyReward.DailyRewardDayElement specialDayElement;
        ...
        private readonly List<_Root.Scripts.Game.Popup.DailyReward.DailyRewardDayElement> _days = new();
